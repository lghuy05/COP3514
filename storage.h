...
/*
    ...
    on functions inside the storage parameter is NULL, it uses malloc to
   allocate one just big enough to contain the function passed as 2nd parameter.
...
/*
    ...
    Takes a pointer to the storage instance and the index of the function to
   retrieve. Returns a pointer to the function, or NULL if the index is out of
   bounds.
*/
